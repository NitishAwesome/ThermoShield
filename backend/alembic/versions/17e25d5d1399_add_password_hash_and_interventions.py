...
def upgrade() -> None:
    ...
    if "interventions" not in tables:
        op.create_table(
            ...
            sa.Column('cooling_center', sa.Boolean(), nullable=False, server_default=sa.text('FALSE')),
            sa.Column('hydration_station', sa.Boolean(), nullable=False, server_default=sa.text('FALSE')),
            sa.Column('outdoor_work_restriction', sa.Boolean(), nullable=False, server_default=sa.text('FALSE')),
